...
<p>Return the result table ordered by <code>Id</code> <strong>in ascending order</strong>. In case of a tie, order it by <code>Month</code> in <strong>descending order</strong>.</p>
